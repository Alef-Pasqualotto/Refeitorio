...
echo "<script>alert('Nota Excluida');</script>";
...
<?php $searchdata=$_POST['searchdata'];?>
                ...
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Resultados da busca "<?php echo $searchdata;?>"</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="cardapio.php">Cardápio</a></li>
                            <li class="breadcrumb-item active">Resultado da Busca </li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                              Detalhes de Resultado da Busca
                            </div>
                            <div class="card-body">
...
?>  
                                ...
                                <tr>
                                            ...
                                            <a href="manage-notes.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Tem certeza que deseja excluir?')" class="btn btn-danger">Delete</a></td>
                                        </tr>
                                        <?php $cnt=$cnt+1; } ?>
